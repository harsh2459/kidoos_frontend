                ...
                <div className="max-w-4xl mx-auto space-y-8">
                    ...
                    <section className="card bg-surface-subtle border-2 border-border">
                        <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1">
                                <h2 className="text-2xl font-bold text-fg mb-3">General Policy</h2>
                                <div className="bg-danger-soft rounded-lg p-4 border border-danger/20 mb-4">
                                    <p className="text-danger font-semibold mb-2">No Refund Policy - Important Notice</p>
                    ...
                    <section className="card">
                        <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1">
                                <h2 className="text-2xl font-bold text-fg mb-3">Duplicate Payments</h2>
                                <p className="text-fg-muted leading-relaxed mb-4">
                    ...
                    {/* Order Cancellations */}
                    <section className="card">
                        <h2 className="text-2xl font-bold text-fg mb-4">Order Cancellations</h2>

                        <div className="space-y-4">
                            <div className="bg-surface-subtle rounded-lg p-4 border border-border-subtle">
                                <div className="flex items-start gap-3 mb-2">
                                    <AlertTriangle className="w-5 h-5 text-fg-muted flex-shrink-0 mt-0.5" />
                                    <div>
                                        <h3 className="text-fg font-semibold mb-2">Before Work Starts</h3>
                            ...
                            <div className="bg-surface-subtle rounded-lg p-4 border border-border-subtle">
                                <div className="flex items-start gap-3 mb-2">
                                    ...
                                    <div>
                                        <h3 className="text-fg font-semibold mb-2">Company-Initiated Cancellation</h3>
                                        <p className="text-fg-muted text-sm leading-relaxed">
                    ...
                    <section className="card">
                        <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1">
                                <h2 className="text-2xl font-bold text-fg mb-3">Custom or Personalized Products</h2>
                                <p className="text-fg-muted leading-relaxed mb-4">
                                ...
                                <div className="bg-surface-subtle rounded-lg p-4 border border-border-subtle">
                                    <h3 className="text-fg font-semibold mb-2 text-sm">Examples Include:</h3>
                    ...
                    <section className="card bg-surface-subtle">
                        <h2 className="text-2xl font-bold text-fg mb-3">Shipping and Handling Charges</h2>
                        <p className="text-fg-muted leading-relaxed mb-4">
                    ...
                    {/* Dispute Resolution */}
                    <section className="card">
                        <h2 className="text-2xl font-bold text-fg mb-4">Dispute Resolution</h2>
                        <p className="text-fg-muted leading-relaxed mb-4">
                        ...
                        <div className="bg-brand/5 rounded-lg p-4 border border-brand/20">
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <p className="text-fg font-semibold mb-2">Review Process</p>
                    ...
                    {/* No Return of Goods */}
                    <section className="card">
                        <h2 className="text-2xl font-bold text-fg mb-4">No Return of Goods</h2>
                        <p className="text-fg-muted leading-relaxed mb-4">
                    ...
                    <section className="card">
                        <h2 className="text-2xl font-bold text-fg mb-3">Modifications to Policy</h2>
                        <p className="text-fg-muted leading-relaxed">
                    ...
                    <section className="card">
                        <div className="text-center">
                            <h2 className="text-2xl font-bold text-fg mb-3">Questions or Concerns?</h2>
