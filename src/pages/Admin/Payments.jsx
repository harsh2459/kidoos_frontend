  ...
  return (
    <div className="mx-auto w-full px-4 sm:px-6 lg:px-8 2xl:px-12 max-w-7xl 2xl:max-w-[1800px] py-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        <div>
          <h1 className="text-3xl font-bold text-[#384959] tracking-tight">Payment Gateways</h1>
      ...
      <div className="max-w-3xl">
        ...
        <div className="bg-white border border-[#E3E8E5] rounded-2xl shadow-sm overflow-hidden mb-6">
          ...
          <div className="bg-[#FAFBF9] border-b border-[#E3E8E5] px-6 py-4 flex items-center justify-between">
            <div className="flex items-center gap-3 font-bold text-[#384959] text-lg">
            ...
            <label className={`
                    ...
                    ${razorpay.enabled ? "bg-[#384959] border-[#384959]" : "bg-white border-[#E3E8E5] hover:bg-[#F4F7F5]"}
                `}>
              <input
                type="checkbox"
          ...
          <div className="p-6 space-y-6">
            <div className="text-sm text-[#5C756D] bg-[#F4F7F5] p-4 rounded-xl border border-[#E3E8E5] flex gap-3 items-start">
              <ShieldCheck className="w-5 h-5 text-[#384959] shrink-0 mt-0.5" />
              <p>
            ...
            <div className="grid grid-cols-1 gap-5">
              ...
              <div>
                ...
                <div className="relative group">
                  <input
                    className="w-full bg-[#FAFBF9] border border-[#E3E8E5] rounded-xl pl-11 pr-4 py-3 text-[#384959] font-mono text-sm focus:outline-none focus:ring-2 focus:ring-[#384959]/20 focus:border-[#384959] transition-all placeholder:text-[#8BA699]"
