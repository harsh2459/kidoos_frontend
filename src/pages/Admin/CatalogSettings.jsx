...
export default function CatalogSettings() {
  ...
  if (loading) return <div className="h-screen flex items-center justify-center"><div className="w-8 h-8 border-4 border-[#384959] border-t-transparent rounded-full animate-spin"></div></div>;
      ...
      <div className="max-w-4xl mx-auto px-6 py-10">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
             ...
             <h1 className="text-3xl font-serif font-bold text-[#384959]">Catalog Page Header</h1>
        ...
        <div className="space-y-8">
           {slides.map((slide, idx) => (
              <div key={idx} className="bg-white border border-[#E3E8E5] p-6 rounded-2xl shadow-sm relative group">
                <span className="absolute -left-3 -top-3 w-8 h-8 bg-[#384959] text-white rounded-full flex items-center justify-center font-bold shadow-md">{idx + 1}</span>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 bg-[#F4F7F5] p-4 rounded-xl">
                        <div>
                            ...
                            <select 
                                ...
                                className="w-full bg-white border border-[#DCE4E0] rounded-lg px-3 py-2 text-sm focus:border-[#384959] outline-none"
                            >
                       ...
                       <div className="md:col-span-2 grid grid-cols-2 gap-4 bg-gray-50 p-4 rounded-xl border border-dashed border-gray-200">
                          <div>
                            ...
                            <div className="flex items-center gap-3">
                                <input type="color" value={slide.bgColor || "#384959"} onChange={(e) => updateSlide(idx, 'bgColor', e.target.value)} className="w-10 h-10 rounded cursor-pointer border-none bg-transparent" />
        ...
        {/* Add Button */}
        <button onClick={addSlide} className="w-full mt-6 py-4 border-2 border-dashed border-[#384959]/30 rounded-2xl flex items-center justify-center gap-2 text-[#384959] font-bold hover:bg-[#384959]/5 transition-colors">
...
function Input({ label, value, onChange, placeholder }) {
  return (
    <div>
      ...
      <input 
        type="text" 
        className="w-full bg-white border border-[#DCE4E0] rounded-xl px-4 py-3 outline-none focus:border-[#384959] focus:ring-2 focus:ring-[#384959]/10 transition-all"
        value={value || ""} 
      ...
      <div className="flex gap-4 items-start">
        <div className="flex-1">
            <div className="relative">
                <label className="flex items-center justify-center gap-2 w-full px-4 py-3 bg-white border border-dashed border-[#384959] rounded-xl cursor-pointer hover:bg-[#F4F7F5] transition-colors text-[#384959] font-medium group">
