...
export default function PreSchool() {
  ...
  return (
    <div className="bg-[#F4F7F5] font-sans text-[#2C3E38] selection:bg-[#D4E2D4] selection:text-[#1A3C34] overflow-x-hidden">
      ...
      <div className="relative w-full pt-20 md:pt-32 pb-20 px-6 border-b border-[#E3E8E5] overflow-hidden bg-[#F4F7F5]">
        ...
        <div className="relative z-10 max-w-6xl mx-auto text-center">
          ...
          <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-white/80 backdrop-blur-sm border border-[#DCE4E0] text-[#1A3C34] text-sm md:text-base font-bold tracking-widest uppercase mb-10 shadow-sm animate-fade-in-up">
            <Sparkles className="w-4 h-4 text-[#4A7C59]" />
            Curated for Ages 3-10
          </div>

          <h1 className="text-4xl md:text-6xl lg:text-7xl xl:text-8xl font-serif font-bold text-[#1A3C34] mb-8 md:mb-10 tracking-tight leading-[1.1] drop-shadow-sm">
            Books That Build <br />
            <span className="text-[#4A7C59] italic pr-2">
              Knowledge & Character
            </span>
          </h1>

          <p className="text-lg md:text-xl lg:text-2xl text-[#5C756D] mb-12 max-w-3xl mx-auto leading-relaxed font-light">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 md:gap-6 w-full sm:w-auto px-4 sm:px-0">
            <Link to="/catalog">
                <button className="w-full sm:w-auto bg-[#1A3C34] text-white px-8 md:px-10 py-4 md:py-5 rounded-xl text-lg font-bold shadow-xl shadow-[#1A3C34]/10 hover:bg-[#2F523F] hover:shadow-2xl hover:-translate-y-1 active:scale-95 transition-all duration-300 flex items-center justify-center gap-2 group">
                Browse Collection
          ...
          <div className="mt-20 md:mt-28 grid grid-cols-2 lg:grid-cols-4 gap-6 md:gap-10 pt-12 border-t border-[#E3E8E5] max-w-6xl mx-auto">
            {[
              ...
              <div key={index} className="text-center group p-4 rounded-xl hover:bg-white/50 transition-colors duration-300">
                <div className="text-xl md:text-3xl font-bold text-[#1A3C34] mb-2 group-hover:text-[#4A7C59] transition-colors font-serif">{metric.value}</div>
                <div className="text-xs md:text-sm font-semibold text-[#8BA699] uppercase tracking-wider">{metric.label}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* --- ABOUT SECTION --- */}
      <div className="py-20 md:py-32 px-6 md:px-12 bg-[#FAFBF9] border-b border-[#E3E8E5]">
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <h2 className="text-3xl md:text-5xl font-serif font-bold mb-8 md:mb-10 text-[#1A3C34]">The Kiddos Intellect Promise</h2>
          <div className="space-y-6 md:space-y-8 text-lg md:text-xl lg:text-2xl text-[#4A5D56] leading-relaxed font-light">
            <p>
              At <span className="font-bold text-[#1A3C34]">Kiddos Intellect</span>, we believe that we don't just sell books—we sell knowledge, values, and character. Every book in our collection is carefully hand-picked or originally created by educators and parents who understand the transformative power of early childhood learning.
            </p>
            <p>
              Our mission is to make <span className="text-[#4A7C59] font-medium border-b-2 border-[#DCE4E0]">quality education accessible</span> to every Indian family. Through timeless stories from mythology, Bhagavad Gita, Ramayana, Bible, and engaging activity books, we help children develop not just academic skills, but also moral values.
            </p>
          </div>
          <div className="mt-12 md:mt-16 flex justify-center">
            <div className="p-4 bg-white rounded-full shadow-md border border-[#E3E8E5]">
              <Feather className="w-10 h-10 md:w-12 md:h-12 text-[#4A7C59]" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="py-20 md:py-32 px-4 md:px-12 bg-white">
        <div className="max-w-screen-xl mx-auto">
          <div className="text-center mb-12 md:mb-20">
            <h2 className="text-3xl md:text-5xl font-serif font-bold text-[#1A3C34] mb-4 md:mb-6">Developmental Stages</h2>
            <p className="text-lg md:text-xl text-[#5C756D] max-w-2xl mx-auto">
          ...
          <div className="flex justify-center mb-12 md:mb-16">
            <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-3 md:gap-2 p-2 bg-[#F4F7F5] rounded-2xl w-full sm:w-auto border border-[#E3E8E5]">
              {ageGroups.map((group, index) => (
                <button
                  ...
                  className={`w-full sm:w-auto px-6 md:px-8 py-4 md:py-3 rounded-xl font-bold transition-all duration-300 text-base md:text-lg ${activeAge === index
                    ? 'bg-white text-[#1A3C34] shadow-sm ring-1 ring-[#DCE4E0] scale-[1.02]'
                    : 'text-[#5C756D] hover:text-[#1A3C34] hover:bg-[#E8F0EB]'
                    }`}
                >
                  {group.age}
                </button>
          ...
          <div className="bg-[#FAFBF9] rounded-[2rem] p-6 md:p-16 border border-[#E3E8E5] shadow-sm relative overflow-hidden">
            <div className="hidden lg:block absolute -top-10 -right-10 opacity-[0.03] pointer-events-none transition-transform duration-700 hover:scale-105">
              <Brain className="w-[500px] h-[500px] text-[#1A3C34]" />
            </div>
            ...
            <div className={`relative z-10 max-w-5xl mx-auto text-center transition-opacity duration-300 ${isAnimating ? 'opacity-0 translate-y-4' : 'opacity-100 translate-y-0'}`}>
              <span className="inline-block text-[#4A7C59] font-bold tracking-widest uppercase text-xs md:text-sm mb-4 bg-[#E8F0EB] px-3 py-1 rounded-full border border-[#DCE4E0]">
                Stage Focus: {ageGroups[activeAge].title}
              </span>

              <h3 className="text-3xl md:text-5xl lg:text-6xl font-serif font-bold text-[#1A3C34] mb-6 md:mb-8">
                Curriculum for {ageGroups[activeAge].age}
              </h3>

              <p className="text-lg md:text-2xl text-[#4A5D56] mb-10 md:mb-14 leading-relaxed font-light max-w-4xl mx-auto">
                {ageGroups[activeAge].description}
              </p>

              <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 md:p-10 shadow-sm border border-[#E3E8E5] mb-4">
                <h4 className="text-sm md:text-base font-bold text-[#8BA699] uppercase tracking-widest mb-6 md:mb-8 border-b border-[#E3E8E5] pb-4 inline-block px-4">
                  Key Skills & Values
                </h4>
                <div className="flex flex-wrap justify-center gap-3 md:gap-4">
                  {ageGroups[activeAge].skills.split(', ').map((skill, i) => (
                    <span key={i} className="px-5 md:px-6 py-2.5 md:py-3 bg-[#F4F7F5] text-[#2C3E38] text-sm md:text-lg font-medium rounded-full border border-[#E3E8E5] flex items-center shadow-sm hover:border-[#4A7C59] hover:bg-[#E8F0EB] transition-colors cursor-default">
                      <Check className="w-4 h-4 md:w-5 md:h-5 mr-2 text-[#4A7C59]" />
                      {skill}
                    </span>
                  ))}
                </div>
      ...
      {/* --- BENEFITS SECTION --- */}
      <div className="py-20 md:py-32 px-6 md:px-12 bg-[#F4F7F5] border-t border-[#E3E8E5]">
        <div className="max-w-screen-2xl mx-auto">
          <h2 className="text-3xl md:text-5xl font-serif font-bold text-center mb-12 md:mb-20 text-[#1A3C34]">Why Parents Trust Us</h2>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {benefits.map((benefit, index) => (
              <div key={index} className="bg-white p-8 md:p-10 rounded-2xl border border-[#E3E8E5] hover:border-[#4A7C59] hover:shadow-lg hover:-translate-y-1 transition-all duration-300 group h-full">
                <div className="w-14 h-14 md:w-16 md:h-16 bg-[#F4F7F5] rounded-xl flex items-center justify-center text-[#1A3C34] mb-6 md:mb-8 group-hover:bg-[#E8F0EB] group-hover:text-[#4A7C59] transition-colors duration-300 shadow-inner">
                  {React.cloneElement(benefit.icon, { className: "w-6 h-6 md:w-8 md:h-8" })}
                </div>
                <h3 className="text-xl md:text-2xl font-bold mb-4 text-[#1A3C34] group-hover:text-[#4A7C59] transition-colors">{benefit.title}</h3>
                <p className="text-base md:text-lg text-[#5C756D] leading-relaxed font-normal">{benefit.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="py-20 md:py-32 px-6 md:px-12 bg-white">
        <div className="max-w-screen-xl mx-auto">
          <h2 className="text-3xl md:text-5xl font-serif font-bold text-center mb-6 text-[#1A3C34]">Our Collections</h2>
          <p className="text-lg md:text-xl text-center text-[#5C756D] mb-16 md:mb-24">Explore our library by genre</p>

          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 md:gap-8">
            {categories.map((category, index) => (
              <div key={index} className="text-center group cursor-pointer">
                <div className="aspect-square rounded-3xl bg-[#F4F7F5] border-2 border-transparent group-hover:border-[#E8F0EB] flex flex-col items-center justify-center mb-6 group-hover:bg-white transition-all duration-300 shadow-sm group-hover:shadow-xl group-hover:-translate-y-2 overflow-hidden relative">
                  <div className="absolute inset-0 bg-[#E8F0EB] opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-3xl -z-10 transform scale-90 group-hover:scale-100"></div>
                ...
                <h3 className="font-bold text-lg md:text-xl text-[#1A3C34] group-hover:text-[#4A7C59] transition-colors mb-1">{category.name}</h3>
                <p className="text-sm md:text-base text-[#8BA699] font-medium group-hover:text-[#5C756D]">{category.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="py-20 md:py-32 px-6 md:px-12 bg-[#1A3C34] text-[#E8F0EB] relative overflow-hidden">
        {/* Background Accent */}
        <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#4A7C59]/20 rounded-full blur-3xl pointer-events-none"></div>

        <div className="max-w-screen-2xl mx-auto relative z-10">
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-24 mb-16 md:mb-24 lg:items-end border-b border-[#4A7C59]/30 pb-16">
            <div className="lg:w-1/2">
              <span className="text-[#8BA699] font-bold tracking-widest uppercase text-sm mb-4 block">Pedagogy</span>
            ...
            <div className="lg:w-1/2">
              <p className="text-xl md:text-2xl text-[#8BA699] font-light leading-relaxed">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
            {whyMythologyMatters.map((item, index) => (
              <div key={index} className="bg-white/5 border border-white/5 p-8 rounded-2xl hover:bg-white/10 hover:border-white/20 transition-all duration-300 hover:-translate-y-1">
                ...
                <p className="text-base md:text-lg text-[#8BA699] leading-relaxed opacity-90">{item.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* --- OUTCOMES --- */}
      <div className="py-20 md:py-32 px-6 md:px-12 bg-[#F4F7F5]">
        <div className="max-w-screen-2xl mx-auto">
          <h2 className="text-3xl md:text-5xl font-serif font-bold text-center mb-16 md:mb-24 text-[#1A3C34]">Holistic Growth</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-12">
            {learningOutcomes.map((outcome, index) => (
              <div key={index} className="flex gap-6 p-6 rounded-2xl hover:bg-white hover:shadow-lg transition-all duration-300 border border-transparent hover:border-[#E3E8E5]">
                <div className="mt-1 flex-shrink-0">
                  <div className="w-12 h-12 rounded-full bg-[#E8F0EB] flex items-center justify-center text-[#4A7C59] shadow-sm">
                    <Check className="w-6 h-6" />
                  </div>
                </div>
                <div>
                  <h3 className="font-bold text-[#1A3C34] text-xl md:text-2xl mb-3">{outcome.title}</h3>
                  <p className="text-base md:text-lg text-[#5C756D] leading-relaxed">{outcome.description}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      {/* --- TESTIMONIALS --- */}
      <div className="py-20 md:py-32 px-6 md:px-12 bg-white border-t border-[#E3E8E5]">
        <div className="max-w-screen-2xl mx-auto">
          <h2 className="text-3xl md:text-5xl font-serif font-bold text-center mb-16 md:mb-24 text-[#1A3C34]">What Parents Say</h2>
          <div className="grid md:grid-cols-3 gap-8 md:gap-12">
            {testimonials.map((testimonial, index) => (
              <div key={index} className="bg-[#FAFBF9] p-8 md:p-12 rounded-[2rem] relative h-full flex flex-col shadow-sm hover:shadow-xl hover:scale-[1.02] transition-all duration-300 border border-[#E3E8E5]">
                <div className="text-8xl text-[#E8F0EB] absolute top-4 left-6 font-serif opacity-50 select-none">"</div>
                <p className="text-lg md:text-xl text-[#4A5D56] mb-8 leading-relaxed relative z-10 pt-8 flex-grow font-medium italic">
                  {testimonial.text}
                </p>
                <div className="border-t border-[#E3E8E5] pt-6 mt-auto flex items-center gap-4">
                  <div className="w-10 h-10 rounded-full bg-[#E8F0EB] flex items-center justify-center font-bold text-[#4A7C59]">
                    {testimonial.name[0]}
                  </div>
                  <div>
                    <p className="font-bold text-[#1A3C34] text-lg leading-tight">{testimonial.name}</p>
                    <p className="text-xs text-[#8BA699] uppercase tracking-wide font-semibold">{testimonial.child}</p>
                    <p className="text-xs text-[#5C756D]">{testimonial.location}</p>
                  </div>
                </div>
              </div>
            ))}
      ...
      <div className="py-20 md:py-32 px-6 md:px-12 bg-[#F4F7F5]">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl md:text-5xl font-serif font-bold text-center mb-12 md:mb-16 text-[#1A3C34]">Frequently Asked Questions</h2>
          <div className="space-y-4 md:space-y-6">
            {faqs.map((faq, index) => (
              <div key={index} className="bg-white border border-[#E3E8E5] rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300">
                <button
                  onClick={() => toggleFaq(index)}
                  className="w-full text-left px-6 md:px-8 py-6 flex justify-between items-center hover:bg-[#FAFBF9] transition-colors"
                >
                  <span className={`font-bold text-lg md:text-xl pr-8 ${openFaq === index ? 'text-[#4A7C59]' : 'text-[#1A3C34]'}`}>
                    {faq.question}
                  </span>
                  <div className={`transition-transform duration-300 ${openFaq === index ? 'rotate-180' : 'rotate-0'}`}>
                    {openFaq === index ? (
                      <ChevronUp className="w-6 h-6 text-[#4A7C59] flex-shrink-0" />
                    ) : (
                      <ChevronDown className="w-6 h-6 text-[#8BA699] flex-shrink-0" />
                    )}
                  </div>
                </button>
                <div
                ...
                >
                  <div className="px-6 md:px-8 pb-8 pt-0 text-base md:text-lg text-[#5C756D] leading-relaxed border-t border-[#E3E8E5] mt-2">
      ...
      {/* --- FOOTER CTA --- */}
      <div className="py-24 md:py-40 px-6 md:px-12 bg-[#1A3C34] text-white text-center relative overflow-hidden">
        {/* Decorative Circles */}
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          <div className="inline-block p-4 rounded-full bg-white/5 mb-8 md:mb-10">
            <Scroll className="w-12 h-12 text-[#8BA699] mx-auto" />
          </div>
          <h2 className="text-4xl md:text-6xl font-serif font-bold mb-8 md:mb-10 tracking-tight">Start Your Child's Journey</h2>
          <p className="text-xl md:text-2xl text-[#8BA699] mb-12 md:mb-16 max-w-3xl mx-auto font-light leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 md:gap-6 w-full sm:w-auto">
            <Link to="/catalog">
              <button className="w-full sm:w-auto bg-white text-[#1A3C34] px-10 py-5 rounded-xl text-lg font-bold shadow-lg hover:bg-[#E8F0EB] hover:-translate-y-1 active:scale-95 transition-all duration-300">
                Shop All Books
              </button>
            </Link>
            <Link to="/contact">
              <button className="w-full sm:w-auto bg-transparent border-2 border-[#8BA699] text-white px-10 py-5 rounded-xl text-lg font-bold hover:bg-white hover:text-[#1A3C34] hover:border-white active:scale-95 transition-all duration-300">
                Contact Us
              </button>
            </Link>
          </div>
